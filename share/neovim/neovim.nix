...
in {
  ...
  programs.nixvim = {
    ...
    extraPlugins = with pkgs.vimPlugins; [
      # Permanent ones
      nvim-highlight-colors # to have a sample of color like this : #8f3188
    ...
    keymaps = [
      # INFO : advice:
      # to not make your keybinds a labyrinth see it like a tree:
      # 1: <leader> to open your personnal keybinds
      # 2: add a category with a letter like 'a'
      # 3: add a other letter to execute the final keybind
      # you can repeat as much as you want the step 2
      # if you use this keybinds a lot, delete step 2
